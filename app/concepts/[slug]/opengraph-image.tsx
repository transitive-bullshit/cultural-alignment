...
export const alt = 'A Cultural Alignment AI safety concept with its full name'
...
export default async function Image({
  ...
  const resource = contentCatalog.getResourcePage('concept', slug)

  if (!resource) notFound()

  return renderTaxonomyOpenGraphImage({
    category: 'AI safety concept',
